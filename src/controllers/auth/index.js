              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td class="logo" style="text-align: center;">
                    <h1><a href="#">QR MENU COMPANY</a></h1>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                      ...
                      <p><a href=${link} target="_blank" class="btn btn-primary">Verify My Email Address.</a></p>
                    </div>
                  </td>
                </tr>
              </table>
...
const Register = async (req, res, next) => {
  ...
  try {
    ...
    await sendEmail(user.email, "Verify Email", emailTemplate(url));
